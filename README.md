...
3. You should see a new entry popup with the following information: ```200 POST classes.vt.edu https://classes.vt.edu/api/?page=sisproxy&action=studentdata```. Double click on this and a new tab should open with more details.
